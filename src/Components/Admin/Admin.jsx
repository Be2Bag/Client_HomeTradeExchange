...
const Admin = () => {
    ...
    const handleDelete = (listingId) => {
        fetch(`https://server-hometradeexchange.onrender.com/listings/${listingId}`, {
            method: 'DELETE',
        })
        .then(response => {
            if (!response.ok) {
    ...
    const handleDeleteMember = (userId) => {
        fetch(`https://server-hometradeexchange.onrender.com/users/${userId}`, {
            method: 'DELETE',
        })
        .then(response => {
            if (!response.ok) {
    ...
    useEffect(() => {
        fetch('https://server-hometradeexchange.onrender.com/listings') // Adjust the URL based on your server configuration
            .then(response => {
                if (!response.ok) {
            ...
            fetch('https://server-hometradeexchange.onrender.com/users')
            .then(response => {
                if (!response.ok) {
                    throw new Error('Network response was not ok');
                }
